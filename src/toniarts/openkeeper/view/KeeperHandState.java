...
public abstract class KeeperHandState extends AbstractAppState {
    ...
    public void initialize(final AppStateManager stateManager, final Application app) {
        ...
        keeperLight = new PointLight(Vector3f.ZERO, lightColor, TILE_WIDTH * 3);
        ...
        //keeperLightDebug.addLight(keeperLight);
    ...
    public void setPosition(float x, float y) {
        ...
        final float lightHeight = TORCH_HEIGHT + TILE_HEIGHT + 0.5f;
